    ...
    sections: {
      ...
      roadmap: {
        ...
        steps: [
          {
            title: "Referral",
            desc: "Clinicians refer eligible patients (LDL > 5.5 mmol/L) to the GAC.",
            detail: "Clinicians in polyclinics, GP clinics, and hospital specialist outpatient clinics refer eligible patients (LDL > 5.5 mmol/L) to the Genomic Assessment Centre (GAC).",
            duration: "Initial clinic visit",
            who: "Polyclinic Doctors, GPs, or Hospital Specialists"
          },
          {
            title: "Pre-Test Counselling",
            desc: "Pre-test counselling at the GAC, covering implications for the patient and their family.",
            detail: "Pre-test counselling at the Genomic Assessment Centre (GAC), covering implications of genetic testing for the patient and their family.",
            duration: "45 to 60 minutes",
            who: "Certified Genetic Counsellor / Clinical Geneticist"
          },
          {
            title: "Genetic Testing",
            desc: "Blood sample collected and analysed for FH-related gene variants.",
            detail: "Genetic testing is performed using a standard blood sample, which is carefully analysed in a specialised laboratory for FH-related gene variants.",
            duration: "10-15 minutes (blood draw)",
            who: "Clinical Nurse & Lab Specialists"
          },
          {
            title: "Post-Test Counselling",
            desc: "Post-test counselling and explanation of results.",
            detail: "Post-test counselling and explanation of results. Meet with your genetic counsellor again to receive and understand your results and discuss potential medical follow-up paths.",
            duration: "30 to 45 minutes",
            who: "Genetic Counsellor & Cardiologist"
          },
          {
            title: "Tailored Treatment",
            desc: "Lipid-lowering therapy adjusted based on the genetic and clinical profile.",
            detail: "Tailored treatment is initiated. Your lipid-lowering therapy is adjusted based on the genetic and clinical profile to effectively manage cholesterol and protect your heart health.",
            duration: "Ongoing lifetime wellness",
            who: "Cardiologist & General Practitioner (GP)"
          },
          {
            title: "Cascade Screening",
            desc: "First-degree relatives of confirmed probands invited for testing.",
            detail: "Cascade screening is offered. First-degree relatives of confirmed probands are invited for testing to protect them proactively before early cardiac symptoms occur.",
            duration: "As requested by family members",
            who: "Certified Genetic Counsellor & Family Members"
          },
          {
            title: "Ongoing Education",
            desc: "Ongoing patient education and clinician training to improve care.",
            detail: "Ongoing patient education and clinician training. Continuous updates on clinical protocols, community support, and public educational resources are provided.",
            duration: "Continuous / Long-term",
            who: "Clinical Educators, Healthcare Professionals & Patients"
          }
        ]
      },
      whyReferred: {
    ...
    sections: {
      ...
      roadmap: {
        ...
        steps: [
          {
            title: "医生转诊",
            desc: "综合诊所、全科诊所和医院专科门诊医生将符合条件的患者（LDL > 5.5 mmol/L）转介至基因评估中心（GAC）。",
            detail: "综合诊所、家庭诊所（GP）和医院专科门诊的临床医生将符合条件（LDL > 5.5 mmol/L）的患者转介给基因评估中心（GAC）。",
            duration: "首次诊所评估",
            who: "综合诊所医生、全科医生 (GP) 及医院专科医生"
          },
          {
            title: "检测前咨询",
            desc: "在基因评估中心（GAC）进行检测前咨询，涵盖对患者及其家属的影响。",
            detail: "在基因评估中心（GAC）进行检测前咨询，涵盖基因检测对患者本人及其家属的潜在健康、心理及保险等各方面影响。",
            duration: "45 至 60 分钟",
            who: "合格遗传咨询师 / 临床遗传学医生"
          },
          {
            title: "基因检测",
            desc: "采集血液样本，分析是否存在与家族性高胆固醇血症（FH）相关的基因变异。",
            detail: "进行基因检测。抽取标准血液样本，并送往专业实验室对与FH相关的关键基因变异进行高精度分析和测序。",
            duration: "10-15 分钟（抽血）",
            who: "临床护士与实验室专家"
          },
          {
            title: "检测后咨询",
            desc: "检测后遗传咨询及详细的结果解读。",
            detail: "检测后咨询及结果说明。您将再次与遗传咨询师会面，获取和解读您的检测结果并规划后续跟进。",
            duration: "30 至 45 分钟",
            who: "遗传咨询师与心脏病专科医生"
          },
          {
            title: "定制化治疗方案",
            desc: "根据患者的基因和临床特征调整降脂治疗方案。",
            detail: "定制化治疗。根据您的具体基因和临床特征，调整降脂疗法（例如他汀类药物或新型注射剂），以达到最佳的心血管保护效果。",
            duration: "长期终身健康管理",
            who: "心脏病专科医生与全科医生 (GP)"
          },
          {
            title: "家属级联筛查",
            desc: "邀请确诊先证者的直系亲属进行针对性基因筛查。",
            detail: "家属级联筛查。邀请确诊先证者的直系亲属（亲生父母、兄弟姐妹和子女）自愿接受针对性基因检测，以便在早期进行预防性治疗。",
            duration: "视家庭成员意愿而定",
            who: "遗传咨询师及家庭成员"
          },
          {
            title: "持续教育与培训",
            desc: "持续开展患者教育和临床医生培训，以不断提高护理水平。",
            detail: "持续患者教育和临床医生培训。通过持续提供患者资源和对临床医生的专业培训，确保新加坡全国范围内的诊疗标准始终保持最新和最高水平。",
            duration: "长期持续",
            who: "临床教育工作者、医疗专业人员与患者"
          }
        ]
      },
      whyReferred: {
    ...
    sections: {
      ...
      roadmap: {
        ...
        steps: [
          {
            title: "Rujukan",
            desc: "Klinisi di poliklinik, klinik GP, dan klinik pesakit luar hospital merujuk pesakit yang layak (LDL > 5.5 mmol/L) ke GAC.",
            detail: "Klinisi di poliklinik, klinik GP, dan klinik pakar pesakit luar hospital merujuk pesakit yang layak (LDL > 5.5 mmol/L) ke Pusat Penilaian Genomik (GAC).",
            duration: "Lawatan klinik awal",
            who: "Doktor Poliklinik, GP, & Pakar Hospital"
          },
          {
            title: "Kaunseling Pra-Ujian",
            desc: "Kaunseling pra-ujian di GAC, merangkumi implikasi untuk pesakit dan keluarga mereka.",
            detail: "Kaunseling pra-ujian di GAC, merangkumi implikasi dan kesan ujian genetik terhadap pesakit dan ahli keluarga mereka.",
            duration: "45 hingga 60 minit",
            who: "Kaunselor Genetik Bertauliah / Pakar Genetik Klinikal"
          },
          {
            title: "Ujian Genetik",
            desc: "Sampel darah diambil dan dianalisis untuk varian gen berkaitan FH.",
            detail: "Ujian genetik dijalankan menggunakan sampel darah biasa, yang dianalisis dengan teliti untuk mengesan varian gen berkaitan FH.",
            duration: "10-15 minit (ambil darah)",
            who: "Jururawat Klinikal & Pakar Makmal"
          },
          {
            title: "Kaunseling Pasca-Ujian",
            desc: "Kaunseling pasca-ujian dan penjelasan mengenai keputusan ujian genetik.",
            detail: "Kaunseling pasca-ujian dan penjelasan mengenai keputusan ujian. Anda akan berjumpa semula dengan kaunselor genetik untuk memahami keputusan dan tindakan susulan.",
            duration: "30 hingga 45 minit",
            who: "Kaunselor Genetik & Pakar Kardiologi"
          },
          {
            title: "Rawatan Khusus",
            desc: "Terapi menurunkan lipid diselaraskan berdasarkan profil genetik dan klinikal.",
            detail: "Rawatan khusus dimulakan. Terapi menurunkan lipid anda diselaraskan berdasarkan profil genetik dan klinikal anda untuk menguruskan kolesterol dengan berkesan.",
            duration: "Kesejahteraan sepanjang hayat",
            who: "Pakar Kardiologi & Doktor Am (GP)"
          },
          {
            title: "Saringan Cascade",
            desc: "Ahli keluarga darjah pertama daripada proband yang sah dijemput untuk ujian.",
            detail: "Saringan cascade ditawarkan. Ahli keluarga terdekat darjah pertama (ibu bapa, adik-beradik, anak-anak) daripada pesakit yang disahkan dijemput untuk menjalani ujian genetik.",
            duration: "Mengikut keperluan ahli keluarga",
            who: "Kaunselor Genetik & Ahli Keluarga"
          },
          {
            title: "Pendidikan & Latihan",
            desc: "Pendidikan pesakit dan latihan klinisi yang berterusan untuk meningkatkan penjagaan.",
            detail: "Pendidikan pesakit dan latihan klinisi yang berterusan dijalankan bagi memastikan perkongsian maklumat terkini, protokol klinikal, dan sumber penjagaan terbaik.",
            duration: "Berterusan / Jangka panjang",
            who: "Pendidik Klinikal, Pakar Penjagaan Kesihatan, & Pesakit"
          }
        ]
      },
      whyReferred: {
    ...
    sections: {
      ...
      roadmap: {
        ...
        steps: [
          {
            title: "பரிந்துரை",
            desc: "பாலிக்ளினிக், ஜிபி கிளினிக் மற்றும் மருத்துவமனை சிறப்பு வெளிநோயாளிகள் கிளினிக்குகளில் உள்ள மருத்துவர்கள் தகுதியுள்ள நோயாளிகளை (LDL > 5.5 mmol/L) GAC க்கு பரிந்துரைக்கின்றனர்.",
            detail: "துணை மருத்துவமனைகள், ஜிபி கிளினிக்குகள் மற்றும் மருத்துவமனை சிறப்பு வெளிநோயாளிகள் கிளினிக்குகளில் உள்ள மருத்துவர்கள் தகுதியுள்ள நோயாளிகளை (LDL > 5.5 mmol/L) மரபணு மதிப்பீட்டு மையத்திற்கு (GAC) பரிந்துரைக்கின்றனர்.",
            duration: "ஆரம்ப கிளினிக் வருகை",
            who: "பாலிக்ளினிக் மருத்துவர்கள், பொது மருத்துவர்கள் & மருத்துவமனை நிபுணர்கள்"
          },
          {
            title: "சோதனைக்கு முந்தைய ஆலோசனை",
            desc: "நோயாளி மற்றும் அவரது குடும்பத்தினருக்கான தாக்கங்களை உள்ளடக்கிய GAC இல் சோதனைக்கு முந்தைய ஆலோசனை.",
            detail: "மரபணு மதிப்பீட்டு மையத்தில் (GAC) சோதனைக்கு முந்தைய ஆலோசனை, இதில் நோயாளி மற்றும் அவரது குடும்பத்தினருக்கு ஏற்படக்கூடிய மரபணு சோதனையின் தாக்கங்கள் விவாதிக்கப்படும்.",
            duration: "45 முதல் 60 நிமிடங்கள்",
            who: "சான்றளிக்கப்பட்ட மரபணு ஆலோசகர் / மருத்துவ மரபியல் நிபுணர்"
          },
          {
            title: "மரபணு சோதனை",
            desc: "இரத்த மாதிரி சேகரிக்கப்பட்டு, எஃப்ஹெச் தொடர்பான மரபணு மாறுபாடுகளுக்கு பகுப்பாய்வு செய்யப்படுகிறது.",
            detail: "மரபணு சோதனை செய்யப்படுகிறது. ஒரு எளிய இரத்த மாதிரி எடுக்கப்பட்டு, சிறப்பு ஆய்வகத்தில் எஃப்ஹெச் தொடர்பான மரபணு மாறுபாடுகளுக்காக (LDLR, APOB, PCSK9) கவனமாக பகுப்பாய்வு செய்யப்படுகிறது.",
            duration: "10-15 நிமிடங்கள் (இரத்தம் எடுத்தல்)",
            who: "மருத்துவ செவிலியர் & ஆய்வக நிபுணர்கள்"
          },
          {
            title: "சோதனைக்கு பிந்தைய ஆலோசனை",
            desc: "சோதனைக்கு பிந்தைய ஆலோசனை மற்றும் முடிவுகளின் விளக்கம்.",
            detail: "சோதனைக்கு பிந்தைய ஆலோசனை மற்றும் முடிவுகளின் விளக்கம். உங்கள் முடிவுகளைப் பெற்று புரிந்துகொள்ளவும், பின்தொடர் சிகிச்சைத் திட்டத்தை வகுக்கவும் உங்கள் மரபணு ஆலோசகரை மீண்டும் சந்திப்பீர்கள்.",
            duration: "30 முதல் 45 நிமிடங்கள்",
            who: "மரபணு ஆலோசகர் & இருதய மருத்துவர்"
          },
          {
            title: "தனிப்பயனாக்கப்பட்ட சிகிச்சை",
            desc: "மரபணு மற்றும் மருத்துவ சுயவிவரத்தின் அடிப்படையில் சரிசெய்யப்படும் கொழுப்பு-குறைப்பு சிகிச்சை.",
            detail: "தனிப்பயனாக்கப்பட்ட சிகிச்சை தொடங்கப்படுகிறது. கொலஸ்ட்ராலை திறம்பட நிர்வகிக்க உங்கள் மரபணு மற்றும் மருத்துவ சுயவிவரத்தின் அடிப்படையில் கொழுப்பு-குறைப்பு சிகிச்சை (Lipid-lowering therapy) சரிசெய்யப்படும்.",
            duration: "தொடர்ந்து வாழ்நாள் முழுவதும் ஆரோக்கியம்",
            who: "இருதய மருத்துவர் & பொது மருத்துவர் (GP)"
          },
          {
            title: "கேஸ்கேட் ஸ்கிரீனிங்",
            desc: "உறுதிப்படுத்தப்பட்ட நோயாளிகளின் முதல்-நிலை உறவினர்கள் சோதனைக்கு அழைக்கப்படுகிறார்கள்.",
            detail: "கேஸ்கேட் ஸ்கிரீனிங் (Cascade screening) வழங்கப்படுகிறது. உறுதிப்படுத்தப்பட்ட நோயாளிகளின் முதல்-நிலை உறவினர்கள் (பெற்றோர், உடன்பிறந்தவர்கள், குழந்தைகள்) தங்களை முன்கூட்டியே பாதுகாத்துக் கொள்ள மரபணு சோதனைக்கு அழைக்கப்படுகிறார்கள்.",
            duration: "குடும்ப உறுப்பினர்களின் விருப்பப்படி",
            who: "மரபணு ஆலோசகர் & குடும்ப உறுப்பினர்கள்"
          },
          {
            title: "தொடர் கல்வி மற்றும் பயிற்சி",
            desc: "பராமரிப்பை மேம்படுத்த தொடர்ந்து நோயாளி கல்வி மற்றும் மருத்துவர் பயிற்சி.",
            detail: "தொடர் நோயாளி கல்வி மற்றும் மருத்துவர் பயிற்சி. சிங்கப்பூரில் எஃப்ஹெச் பராமரிப்பின் மிக உயர்ந்த தரத்தை பராமரிக்க, புதிய தகவல்கள், மருத்துவ வழிகாட்டுதல்கள் மற்றும் பொது வளங்கள் தொடர்ந்து வழங்கப்படுகின்றன.",
            duration: "தொடர்ச்சியான / நீண்ட கால",
            who: "மருத்துவ கல்வியாளர்கள், சுகாதார வல்லுநர்கள் & நோயாளிகள்"
          }
        ]
      },
      whyReferred: {
